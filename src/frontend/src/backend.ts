...
import type { ExternalBlob as _ExternalBlob, FurnitureItem as _FurnitureItem, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createFurnitureItem(arg0: string, arg1: string, arg2: string, arg3: string, arg4: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createFurnitureItem(arg0, arg1, arg2, arg3, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteFurnitureItem(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteFurnitureItem(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllFurnitureItems(): Promise<Array<FurnitureItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllFurnitureItems();
    ...
    async getFurnitureItem(arg0: string): Promise<FurnitureItem | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getFurnitureItem(arg0);
    ...
    async getUniqueCategories(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUniqueCategories();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateFurnitureItem(arg0: string, arg1: string, arg2: string, arg3: string, arg4: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateFurnitureItem(arg0, arg1, arg2, arg3, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_FurnitureItem_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FurnitureItem): Promise<FurnitureItem> {
...
async function from_candid_opt_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_FurnitureItem]): Promise<FurnitureItem | null> {
    return value.length === 0 ? null : await from_candid_FurnitureItem_n12(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_FurnitureItem>): Promise<Array<FurnitureItem>> {
    return await Promise.all(value.map(async (x)=>await from_candid_FurnitureItem_n12(_uploadFile, _downloadFile, x)));
}
